    ...
    return (
        <div className="animate-slide-up max-w-5xl mx-auto space-y-12 pb-20 px-4 md:px-0">
            ...
            <div className="text-center md:text-left space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-full text-[10px] font-black uppercase tracking-widest border border-emerald-100 dark:border-emerald-900/30">
                    💎 Asset Protection
                </div>
                        ...
                        <div className="p-10 flex flex-col lg:flex-row gap-12">
                            ...
                            <div className="flex-1 space-y-10">
                                ...
                                <div className="p-8 bg-slate-900 dark:bg-white rounded-[2rem] text-white dark:text-slate-900 shadow-xl">
                                    <h4 className="text-[10px] font-black uppercase tracking-widest mb-3 opacity-60">Recomendação de Segurança</h4>
