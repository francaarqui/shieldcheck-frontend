                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 text-center md:text-left">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-sm font-bold">
                            <li><Link to="/#how-it-works" className="hover:text-indigo-400 transition-colors">{t('footer.links.how_it_works')}</Link></li>
                            <li><Link to="/analyze" className="hover:text-indigo-400 transition-colors">{t('footer.links.analyze')}</Link></li>
                            <li><Link to="/store-checker" className="hover:text-indigo-400 transition-colors">{t('footer.links.stores')}</Link></li>
                            <li><Link to="/academy" className="hover:text-indigo-400 transition-colors">{t('footer.links.academy')}</Link></li>
                            <li><Link to="/b2b-portal" className="hover:text-indigo-400 transition-colors">{t('footer.links.api')}</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-sm font-bold">
                            <li><Link to="/help" className="hover:text-indigo-400 transition-colors">{t('footer.links.help_center')}</Link></li>
                            <li><Link to="/community" className="text-red-400 hover:text-red-500 transition-colors">{t('footer.links.report_scam')}</Link></li>
                            <li><Link to="/fraud-dictionary" className="hover:text-indigo-400 transition-colors">{t('footer.links.fraud_dictionary')}</Link></li>
                            <li><Link to="/status" className="hover:text-indigo-400 transition-colors">{t('footer.links.system_status')}</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-sm font-bold">
                            <li><Link to="/privacy" className="hover:text-indigo-400 transition-colors">{t('footer.links.privacy_policy')}</Link></li>
                            <li><Link to="/terms" className="hover:text-indigo-400 transition-colors">{t('footer.links.terms_of_use')}</Link></li>
                            <li><Link to="/privacy" className="hover:text-indigo-400 transition-colors">Cookies & LGPD</Link></li>
                        </ul>
                    </div>
                </div>
